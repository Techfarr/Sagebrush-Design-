...
export const projects = [
  {
    ...
    evidence: [
      { type: "Instructional design", title: "Critical-thinking thread", description: "A requested teaching point carried through ELT and ILT rather than isolated in one lesson.", slot: "safety-critical-thinking", src: "assets/projects/safety-investigations/safety-critical-thinking.jpg",
        seeing: "The public portfolio sample explains how learners repeatedly distinguish evidence from assumptions, identify unknowns, and revise conclusions.",
      ...
      { type: "Framework", title: "SHIELD across the system", description: "The six-step investigation framework used to organize the experience across formats.", slot: "safety-shield", src: "assets/projects/safety-investigations/safety-shield.jpg",
        seeing: "A public-safe view of the SHIELD framework as it is explained in the portfolio sample.",
      ...
      { type: "Validation", title: "Evidence boundary", description: "Verified learner-response evidence presented with an explicit boundary around what was and was not measured.", slot: "safety-validation", src: "assets/projects/safety-investigations/safety-validation.jpg",
