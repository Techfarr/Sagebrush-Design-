...
export const projects = [
  {
    ...
    homeImages: [
      { type: "Digital learning", title: "eLearning scenario", description: "Representative decision practice for a safety investigation.", seeing: "A representative eLearning activity asking the learner what to do first after equipment damage.", src: "assets/projects/safety-investigations/approved/elearning.png", fit: "contain", alt: "Representative eLearning decision activity with a dented baggage cart and a traffic cone." },
      { type: "Framework", title: "SHIELD reference", description: "The six-step investigation framework used across the learning system.", seeing: "A representative SHIELD reference with six colored icons.", src: "assets/projects/safety-investigations/approved/shield.png", fit: "contain", alt: "SHIELD reference with six colored icons for Secure the Scene, Health Check, Inform, Evidence, Listen, and Document." },
      { type: "Facilitated learning", title: "Facilitated practice", description: "Incident photographs and a worksheet support evidence-based discussion.", seeing: "Representative investigation materials for facilitated practice.", src: "assets/projects/safety-investigations/approved/facilitated-practice.png", fit: "contain", alt: "Representative facilitated practice with incident photographs and an investigation worksheet." }
    ],
    evidence: [
      { type: "Instructional design", title: "Interview practice", description: "Representative practice contrasting leading questions with open prompts.", slot: "safety-critical-thinking", src: "assets/projects/safety-investigations/approved/interview-practice.png", fit: "contain", alt: "Representative interview practice contrasting leading and open questions.",
      ...
      { type: "Design iteration", title: "Pilot-driven revision", description: "A representative visual of the shift from open discovery to guided investigation.", slot: "safety-validation", src: "assets/projects/safety-investigations/approved/pilot-revision.png", fit: "contain", alt: "Representative pilot revision from open discovery to guided investigation.",
