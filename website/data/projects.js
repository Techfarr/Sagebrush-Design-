...
export const projects = [
  {
    ...
    homeImages: [
      { type: "Digital learning", title: "Critical-thinking practice", description: "A sanitized capture from the public portfolio sample, grounded in the actual learning design.", seeing: "A sanitized sample capture showing the evidence-versus-assumption reasoning used in the delivered learning.", src: "assets/projects/safety-investigations/safety-critical-thinking.jpg", alt: "Sanitized capture from the Safety Investigations sample showing evidence-based critical-thinking practice." },
      { type: "Framework", title: "SHIELD reference", description: "A sanitized capture of the repeatable investigation framework used across the learning system.", seeing: "A sanitized sample capture showing the SHIELD framework and its role across multiple learning formats.", src: "assets/projects/safety-investigations/safety-shield.jpg", alt: "Sanitized capture showing the SHIELD safety-investigation framework." },
      { type: "Validation", title: "Pilot and learner response", description: "A sanitized capture separating verified learner evidence from unmeasured operational outcomes.", seeing: "A sanitized sample capture showing the project's validation boundary and learner-response evidence.", src: "assets/projects/safety-investigations/safety-validation.jpg", alt: "Sanitized capture showing validation evidence and claim boundaries for Safety Investigations." }
    ],
    evidence: [
      { type: "Instructional design", title: "Critical-thinking practice", description: "Sanitized capture of the evidence-versus-assumption reasoning used in the learning.", slot: "safety-critical-thinking", src: "assets/projects/safety-investigations/safety-critical-thinking.jpg", alt: "Sanitized Safety Investigations capture showing evidence-based critical-thinking practice.",
        seeing: "A sanitized capture grounded in the actual delivered learning design, with proprietary identifiers removed.",
      ...
      { type: "Performance support", title: "SHIELD framework", description: "Sanitized capture of the investigation framework used across the learning ecosystem.", slot: "safety-shield", src: "assets/projects/safety-investigations/safety-shield.jpg", alt: "Sanitized Safety Investigations capture showing the SHIELD framework.",
        seeing: "A sanitized capture showing the same repeatable framework carried across digital learning, facilitated practice, and job support.",
      ...
      { type: "Validation", title: "Pilot and learner response", description: "Sanitized capture showing verified learner evidence and explicit limits on outcome claims.", slot: "safety-validation", src: "assets/projects/safety-investigations/safety-validation.jpg", alt: "Sanitized Safety Investigations capture showing validation evidence and claim boundaries.",
        seeing: "A sanitized capture showing verified learner-response evidence while keeping unmeasured operational outcomes separate.",
