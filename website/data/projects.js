...
export const projects = [
  {
    ...
    homeImages: [
      { type: "Digital learning", title: "Fact or assumption practice", description: "A faithful public-safe reconstruction of the Rise interaction used to separate verified facts from assumptions.", seeing: "A sanitized reconstruction of the Rise sorting activity. The interaction structure and information hierarchy follow the delivered learning while client branding and proprietary examples are removed.", src: "assets/projects/safety-investigations/portfolio/elearning-fact-assumption.svg", alt: "Sanitized reconstruction of a Rise 360 fact versus assumption interaction from Safety Investigations." },
      { type: "Facilitated learning", title: "The Reframe", description: "A faithful reconstruction of the ILT reveal that introduces new evidence after learners commit to an initial finding.", seeing: "A sanitized reconstruction of the facilitated Reframe slide, including the aligned SHIELD rail and three causation levels.", src: "assets/projects/safety-investigations/portfolio/ilt-reframe.svg", alt: "Sanitized reconstruction of the Safety Investigations facilitated Reframe slide." },
      { type: "Performance support", title: "Quick Reference Guide", description: "A public-safe reconstruction of the QRG learners could take back to the operation.", seeing: "A sanitized reconstruction of the first page of the Safety Investigation Quick Reference Guide, preserving the document structure while removing client-specific procedures.", src: "assets/projects/safety-investigations/portfolio/qrg-overview.svg", alt: "Sanitized reconstruction of the Safety Investigation Quick Reference Guide." }
    ],
    evidence: [
